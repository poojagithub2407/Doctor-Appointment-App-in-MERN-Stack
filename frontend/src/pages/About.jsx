...
const About = () => {
     return (
          <div>
               ...
               <div className="my-10 flex flex-col md:flex-row gap-12">
                    ...
                    <div className="flex flex-col justify-center gap-6 md:w-2/4 text-sm text-gray-600">
                         <p>
                              ...
                              Prescripto, we understand the challenges individuals face
                              when it comes to scheduling doctor appointments and managing
               ...
               <div className="flexflex-col md:flex-row mb-20">
                    <div className="border px-10 md:px-16 py-8 sm:py-16 flex flex-col gap-5 text-[15px] hover:bg-primary hover:text-white transition-all duration-600 cursor-pointer">
                         <b>EFFICIENCY:</b>
